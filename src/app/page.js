...
const OmarPortfolio = () => {
  ...
  const socialLinks = [
    { 
      icon: <Github size={32} className="text-gray-400 hover:text-gray-500 transition-colors" />, 
      href: "https://github.com/cslomarfaruk" 
    },
    { 
      icon: <Facebook size={32} className="text-sky-400 hover:text-sky-300 transition-colors" />, 
      href: "https://facebook.com/cslomarfaruk1" 
    },
    { 
      icon: <PhoneCall size={32} className="text-green-400 hover:text-green-300 transition-colors" />, 
      href: "https://wa.me/+8801839467728" 
    },
    { 
      icon: <Linkedin size={32} className="text-sky-400 hover:text-sky-300 transition-colors" />, 
      href: "https://linkedin.com/in/csl-omarfaruk" 
    },
    { 
      icon: <Instagram size={32} className="text-pink-400 hover:text-pink-300 transition-colors" />, 
      href: "https://instagram.com/cslomarfaruk" 
    },
    { 
      icon: <Twitter size={32} className="text-sky-400 hover:text-sky-300 transition-colors" />, 
  ...
  return (
    <div className={`min-h-screen ${isDarkMode ? 'bg-gradient-to-br from-gray-900 to-black' : 'bg-gradient-to-br from-blue-50 to-blue-100'} flex items-center justify-center p-4 relative overflow-hidden`}>
      {/* Animated Background */}
      <div className={`absolute inset-0 opacity-20 ${isDarkMode ? 'bg-grid-white/[0.05]' : 'bg-grid-black/[0.05]'}`}></div>
      ...
      <div className={`relative z-10 shadow-2xl rounded-2xl p-8 m-2 max-w-lg w-full transform hover:scale-[1.02] transition-transform duration-300 ${isDarkMode ? 'bg-gray-800 text-white' : 'bg-white text-gray-800'}`}>        <div className="text-center">
          ...
          <div className={`rounded-xl p-4 mb-6 ${isDarkMode ? 'bg-gray-700' : 'bg-blue-50'}`}>
          ...
          <div className={`rounded-xl p-4 mb-6 ${isDarkMode ? 'bg-gray-700' : 'bg-blue-50'}`}>
            ...
            <div className="space-y-2">
              {contactDetails.map((detail, index) => (
                <div key={index} className="flex items-center justify-center gap-2 opacity-90">
                  {detail.icon}
